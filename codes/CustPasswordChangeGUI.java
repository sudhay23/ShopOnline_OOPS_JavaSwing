...
public class CustPasswordChangeGUI
{
    ...
    {
        CustomerPasswordChange myCustomer = new CustomerPasswordChange();
    }
}
...
class CustomerPasswordChange extends JFrame implements ActionListener
{
    ...
    {
        frame = new JFrame("Change Customer Password | ShopOnline - E-Commerce Platform");
        panel = new JPanel();
        ...
        heading = new JLabel("Change Customer Password");
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       else if(e.getSource()==confirmBtn)
       {
           ...
           if(Customer.checkUsername(usernameText.getText())==1)
           {
                ...
                int result = Customer.changePassword(usernameText.getText(),oldPasswordText.getText(),newPasswordText.getText());
                if(result==0)
                {
